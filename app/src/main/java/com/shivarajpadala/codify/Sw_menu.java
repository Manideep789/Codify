...
public class Sw_menu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sw_menu);
        ...
        Webcompiler.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Sw_menu.this,Compiler.class);
                startActivity(i);
            }
        });
        ...
        c5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(Sw_menu.this,Online_test.class);
                startActivity(i);
            }
        });
    }
